...
REM SET DEFAULT_DOMAIN=AAD_Default
...
REM MAKE SURE TO NOT INCLUDE "/" AT THE END OF URL
REM Since AIP Console >= 3.5, AAD has been renamed to AAD_Default
REM SET HD_DOMAIN=AAD_Default
SET HD_DOMAIN=AAD   
...
REM TO LIMIT THE INTERVAL OF SNAPSHOTS IN MONTHS, SET THE FOLLOWING VARIABLE
REM SET EXTRACT_SNAPSHOTS_MONTHS=6
