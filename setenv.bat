...
IF DEFINED CREDENTIALS FOR /F "tokens=* USEBACKQ" %%D IN (`python %INSTALLATION_FOLDER%\utilities\decode.py %CREDENTIALS%`) DO (SET CREDENTIALS=%%D)
IF DEFINED PGPASSWORD FOR /F "tokens=* USEBACKQ" %%D IN (`python %INSTALLATION_FOLDER%\utilities\decode.py %PGPASSWORD%`) DO (SET PGPASSWORD=%%D)
