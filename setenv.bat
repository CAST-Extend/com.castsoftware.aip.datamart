...
REM SET REST API URL, DOMAIN, and QUALITY STANDARD TAGS
REM MAKE SURE TO NOT INCLUDE "/" AT THE END OF URL
REM EXAMPLE: 
SET ROOT=http://localhost:9090/CAST-RESTAPI/rest
SET DOMAIN=AAD
...
IF NOT DEFINED DOMAIN (echo Missing variable DOMAIN & EXIT /b 1)
