...
call :extract datamart/app-health-results                   APP_HEALTH_RESULTS                  || EXIT /b 1
call :extract datamart/app-scores-results                   APP_SCORES_RESULTS                  || EXIT /b 1
...
call :extract datamart/mod-health-results                   MOD_HEALTH_RESULTS                  || EXIT /b 1
call :extract datamart/mod-scores-results                   MOD_SCORES_RESULTS                  || EXIT /b 1
