...
DROP TABLE IF EXISTS :schema.SRC_APP_OBJECTS CASCADE;
CREATE TABLE :schema.SRC_APP_OBJECTS
(
    APPLICATION_NAME TEXT,
    OBJECT_ID INT,
    OBJECT_NAME TEXT,
    CONSTRAINT SRC_APP_OBJECTS_PKEY PRIMARY KEY (APPLICATION_NAME, OBJECT_ID)
);
