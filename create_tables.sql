...
----------------
-- APPLICATIONS RESULTS TABLES
----------------

DROP TABLE IF EXISTS :schema.APP_HEALTH_RESULTS CASCADE;
CREATE TABLE :schema.APP_HEALTH_RESULTS
(
    SNAPSHOT_ID TEXT,
    ...
    NB_VIOLATIONS INT,
    SCORE NUMERIC,
    CONSTRAINT APP_HEALTH_RESULTS_PKEY PRIMARY KEY (SNAPSHOT_ID, BUSINESS_CRITERION_NAME),
    FOREIGN KEY (SNAPSHOT_ID) REFERENCES :schema.DIM_SNAPSHOTS(SNAPSHOT_ID)        
);

DROP TABLE IF EXISTS :schema.APP_SCORES_RESULTS CASCADE;
CREATE TABLE :schema.APP_SCORES_RESULTS
(
    SNAPSHOT_ID TEXT,
    METRIC_ID INT,
    METRIC_NAME TEXT,
    METRIC_TYPE TEXT,
    SCORE DECIMAL,
    CONSTRAINT APP_SCORES_RESULTS_PKEY PRIMARY KEY (SNAPSHOT_ID, METRIC_ID),
    FOREIGN KEY (SNAPSHOT_ID) REFERENCES :schema.DIM_SNAPSHOTS(SNAPSHOT_ID)
);
...
----------------
-- MODULES RESULTS TABLES
----------------

DROP TABLE IF EXISTS :schema.MOD_HEALTH_RESULTS CASCADE;
CREATE TABLE :schema.MOD_HEALTH_RESULTS
(
    SNAPSHOT_ID TEXT,
    MODULE_NAME TEXT,    
    BUSINESS_CRITERION_NAME TEXT,
    ...
    NB_VIOLATIONS INT,
    SCORE NUMERIC,
    CONSTRAINT MOD_HEALTH_RESULTS_PKEY PRIMARY KEY (SNAPSHOT_ID, MODULE_NAME, BUSINESS_CRITERION_NAME),
    FOREIGN KEY (SNAPSHOT_ID) REFERENCES :schema.DIM_SNAPSHOTS(SNAPSHOT_ID)        
);

DROP TABLE IF EXISTS :schema.MOD_SCORES_RESULTS CASCADE;
CREATE TABLE :schema.MOD_SCORES_RESULTS
(
    SNAPSHOT_ID TEXT,
    MODULE_NAME TEXT,
    METRIC_ID INT,
    ...
    METRIC_TYPE TEXT,
    SCORE DECIMAL,
    CONSTRAINT MOD_SCORES_RESULTS_PKEY PRIMARY KEY (SNAPSHOT_ID, MODULE_NAME, METRIC_ID),
    FOREIGN KEY (SNAPSHOT_ID) REFERENCES :schema.DIM_SNAPSHOTS(SNAPSHOT_ID)
);
