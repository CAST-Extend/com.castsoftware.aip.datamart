...
-- DIMENSION TABLES
----------------
DROP TABLE IF EXISTS DIM_SNAPSHOTS CASCADE;
CREATE TABLE DIM_SNAPSHOTS
(
    SNAPSHOT_ID TEXT,
    APPLICATION_ID INT,
...
DROP TABLE IF EXISTS DIM_RULES CASCADE;
...
DROP TABLE IF EXISTS DIM_OMG_RULES CASCADE;
...
DROP TABLE IF EXISTS DIM_CISQ_RULES CASCADE;
...
DROP TABLE IF EXISTS APP_VIOLATIONS_MEASURES CASCADE;
CREATE TABLE APP_VIOLATIONS_MEASURES
(
    SNAPSHOT_ID TEXT,
    RULE_ID TEXT,
    TECHNOLOGY TEXT,  
...
DROP TABLE IF EXISTS APP_SIZING_MEASURES CASCADE;
CREATE TABLE APP_SIZING_MEASURES
(
    SNAPSHOT_ID TEXT,
    NB_ARTIFACTS INT,
    NB_CODE_LINES INT,
...
DROP TABLE IF EXISTS APP_FUNCTIONAL_SIZING_MEASURES CASCADE;
CREATE TABLE APP_FUNCTIONAL_SIZING_MEASURES
(
    SNAPSHOT_ID TEXT,
...
DROP TABLE IF EXISTS APP_HEALTH_SCORES CASCADE;
...
DROP TABLE IF EXISTS APP_SCORES CASCADE;
...
DROP TABLE IF EXISTS APP_SIZING_EVOLUTION CASCADE;
CREATE TABLE APP_SIZING_EVOLUTION
(
    SNAPSHOT_ID TEXT,
...
DROP TABLE IF EXISTS APP_FUNCTIONAL_SIZING_EVOLUTION CASCADE;
CREATE TABLE APP_FUNCTIONAL_SIZING_EVOLUTION
(
    SNAPSHOT_ID TEXT,
    PREVIOUS_SNAPSHOT_ID TEXT,
...
DROP TABLE IF EXISTS APP_HEALTH_EVOLUTION CASCADE;
CREATE TABLE APP_HEALTH_EVOLUTION
(
    SNAPSHOT_ID TEXT,
    PREVIOUS_SNAPSHOT_ID TEXT,
    BUSINESS_CRITERION_NAME TEXT,
...
DROP TABLE IF EXISTS MOD_SIZING_MEASURES CASCADE;
CREATE TABLE MOD_SIZING_MEASURES
(
    SNAPSHOT_ID TEXT,
    MODULE_NAME TEXT,
    NB_ARTIFACTS INT,
...
DROP TABLE IF EXISTS MOD_VIOLATIONS_MEASURES CASCADE;
CREATE TABLE MOD_VIOLATIONS_MEASURES
(
    SNAPSHOT_ID TEXT,
    MODULE_NAME TEXT,
    RULE_ID TEXT,
...
DROP TABLE IF EXISTS MOD_HEALTH_SCORES CASCADE;
CREATE TABLE MOD_HEALTH_SCORES
(
    SNAPSHOT_ID TEXT,
    MODULE_NAME TEXT,    
    BUSINESS_CRITERION_NAME TEXT,
...
DROP TABLE IF EXISTS MOD_SCORES CASCADE;
CREATE TABLE MOD_SCORES
(
    SNAPSHOT_ID TEXT,
    MODULE_NAME TEXT,
    METRIC_ID INT,
...
DROP TABLE IF EXISTS MOD_SIZING_EVOLUTION CASCADE;
CREATE TABLE MOD_SIZING_EVOLUTION
(
    SNAPSHOT_ID TEXT,
    PREVIOUS_SNAPSHOT_ID TEXT,
    MODULE_NAME TEXT,
...
DROP TABLE IF EXISTS MOD_HEALTH_EVOLUTION CASCADE;
CREATE TABLE MOD_HEALTH_EVOLUTION
(
    SNAPSHOT_ID TEXT,
    PREVIOUS_SNAPSHOT_ID TEXT,
    MODULE_NAME TEXT,    
...
DROP TABLE IF EXISTS STD_RULES CASCADE;
...
DROP TABLE IF EXISTS STD_DESCRIPTIONS CASCADE;
CREATE TABLE STD_DESCRIPTIONS
(
    STANDARD TEXT,
    CATEGORY TEXT, 
    TAG TEXT,
...
DROP TABLE IF EXISTS SRC_OBJECTS CASCADE;
CREATE TABLE SRC_OBJECTS
(
    APPLICATION_NAME TEXT,
    OBJECT_ID TEXT,
    OBJECT_NAME TEXT,
...
DROP INDEX IF EXISTS SRC_OBJECTS_IDX;
CREATE INDEX SRC_OBJECTS_IDX ON SRC_OBJECTS USING btree(APPLICATION_NAME, OBJECT_ID);

DROP TABLE IF EXISTS SRC_MOD_OBJECTS CASCADE;
CREATE TABLE SRC_MOD_OBJECTS
(
    APPLICATION_NAME TEXT,
    MODULE_NAME TEXT,
    OBJECT_ID TEXT
);
DROP INDEX IF EXISTS SRC_MOD_OBJECTS_IDX;
CREATE INDEX SRC_MOD_OBJECTS_IDX ON SRC_MOD_OBJECTS USING btree(APPLICATION_NAME, MODULE_NAME, OBJECT_ID);
CREATE INDEX SRC_MOD_OBJECTS_IDX2 ON SRC_MOD_OBJECTS USING btree(MODULE_NAME, OBJECT_ID);

DROP TABLE IF EXISTS SRC_TRANSACTIONS CASCADE;
...
DROP INDEX IF EXISTS SRC_TRANSACTIONS_IDX;
CREATE INDEX SRC_TRANSACTIONS_IDX ON SRC_TRANSACTIONS USING btree(APPLICATION_NAME, TRX_ID);

DROP TABLE IF EXISTS SRC_TRX_OBJECTS CASCADE;
CREATE TABLE SRC_TRX_OBJECTS
(
    TRX_ID TEXT,
    OBJECT_ID TEXT
);

DROP TABLE IF EXISTS SRC_TRX_HEALTH_IMPACTS CASCADE;
...
DROP TABLE IF EXISTS SRC_VIOLATIONS CASCADE;
CREATE TABLE SRC_VIOLATIONS
(
    SNAPSHOT_ID TEXT,
    RULE_ID TEXT,
    METRIC_ID INT,
...
DROP TABLE IF EXISTS SRC_HEALTH_IMPACTS CASCADE;
CREATE TABLE SRC_HEALTH_IMPACTS
(
    SNAPSHOT_ID TEXT,
    OBJECT_ID TEXT, 
    OBJECT_NAME TEXT,
...
DROP TABLE IF EXISTS USR_EXCLUSIONS CASCADE;
CREATE TABLE USR_EXCLUSIONS
(
    APPLICATION_NAME TEXT,
    RULE_ID TEXT,
    RULE_NAME TEXT,
...
DROP INDEX IF EXISTS USR_EXCLUSIONS_IDX;
CREATE INDEX USR_EXCLUSIONS_IDX ON USR_EXCLUSIONS USING btree(APPLICATION_NAME, OBJECT_ID, RULE_ID);

DROP TABLE IF EXISTS USR_ACTION_PLAN CASCADE;
CREATE TABLE USR_ACTION_PLAN
(
    APPLICATION_NAME TEXT,
    RULE_ID TEXT,
    RULE_NAME TEXT,
...
DROP INDEX IF EXISTS USR_ACTION_PLAN_IDX;
CREATE INDEX USR_ACTION_PLAN_IDX ON USR_ACTION_PLAN USING btree(APPLICATION_NAME, OBJECT_ID, RULE_ID);