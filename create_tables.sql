...
(
    RULE_ID TEXT,
    RULE_NAME TEXT,
    BUSINESS_CRITERION_ID INT,
    BUSINESS_CRITERION_NAME TEXT,
    TECHNICAL_CRITERION_WEIGHT NUMERIC,
    TECHNICAL_CRITERION_ID INT,
...
(
    ...
    NB_COMPLEXITY_VERY_HIGH INT,
    NB_COMPLEXITY_HIGH INT,
    NB_COMPLEXITY_MEDIUM INT,
    NB_COMPLEXITY_LOW INT,
    NB_CYCLOMATIC_VERY_HIGH INT,
    NB_CYCLOMATIC_HIGH INT,
    NB_CYCLOMATIC_MEDIUM INT,
    NB_CYCLOMATIC_LOW INT,
...
(
    ...
    NB_VIOLATIONS_ADDED INT,
    NB_VIOLATIONS_REMOVED INT,
    OMG_TECHNICAL_DEBT_ADDED INT,
    OMG_TECHNICAL_DEBT_DELETED INT,    
...
DROP TABLE IF EXISTS :schema.APP_FINDINGS_MEASURES CASCADE;
