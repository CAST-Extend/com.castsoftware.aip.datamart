...
if __name__ == "__main__":
    ...
    if args.mode in ['refresh', 'install', 'refresh_measures']:
        ...
        transform(args.mode, args.extract_directory, args.transform_directory, "APP_HEALTH_RESULTS")
        transform(args.mode, args.extract_directory, args.transform_directory, "APP_SCORES_RESULTS")
        ...
        transform(args.mode, args.extract_directory, args.transform_directory, "MOD_HEALTH_RESULTS")
        transform(args.mode, args.extract_directory, args.transform_directory, "MOD_SCORES_RESULTS")        
