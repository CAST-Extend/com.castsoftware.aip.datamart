...
DO $$ 
    BEGIN
        ...
        BEGIN 
            ALTER TABLE APP_HEALTH_SCORES ADD COLUMN OMG_TECHNICAL_DEBT BIGINT;
            ALTER TABLE MOD_HEALTH_SCORES ADD COLUMN OMG_TECHNICAL_DEBT BIGINT;
            ALTER TABLE APP_HEALTH_EVOLUTION ADD COLUMN OMG_TECHNICAL_DEBT_ADDED BIGINT;
            ALTER TABLE APP_HEALTH_EVOLUTION ADD COLUMN OMG_TECHNICAL_DEBT_DELETED BIGINT;
            ALTER TABLE MOD_HEALTH_EVOLUTION ADD COLUMN OMG_TECHNICAL_DEBT_ADDED BIGINT;
            ALTER TABLE MOD_HEALTH_EVOLUTION ADD COLUMN OMG_TECHNICAL_DEBT_DELETED BIGINT;
        EXCEPTION
            WHEN OTHERS THEN 
                RAISE NOTICE 'Columns OMG_TECHNICAL_DEBT, OMG_TECHNICAL_DEBT_ADDED, OMG_TECHNICAL_DEBT_ADDED already exist fo XXX_HEALTH_YYY tables';
        END;
 
       BEGIN 
            -- If previously created as INT, change column type to BIGINT
            IF EXISTS (
                SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS 
                WHERE TABLE_SCHEMA = current_schema()
                AND TABLE_NAME = 'app_health_scores' 
                AND COLUMN_NAME = 'omg_technical_debt' 
                AND DATA_TYPE = 'integer')
            THEN
                DROP VIEW IF EXISTS app_iso_scores_view CASCADE;
                DROP VIEW IF EXISTS datapond_basedata CASCADE;
                ALTER TABLE APP_HEALTH_SCORES ALTER COLUMN OMG_TECHNICAL_DEBT TYPE BIGINT USING OMG_TECHNICAL_DEBT::BIGINT;
                ALTER TABLE MOD_HEALTH_SCORES ALTER COLUMN OMG_TECHNICAL_DEBT TYPE BIGINT USING OMG_TECHNICAL_DEBT::BIGINT;
                ALTER TABLE APP_HEALTH_EVOLUTION ALTER COLUMN OMG_TECHNICAL_DEBT_ADDED TYPE BIGINT USING OMG_TECHNICAL_DEBT_ADDED::BIGINT;
                ALTER TABLE APP_HEALTH_EVOLUTION ALTER COLUMN OMG_TECHNICAL_DEBT_DELETED TYPE BIGINT USING OMG_TECHNICAL_DEBT_DELETED::BIGINT;
                ALTER TABLE MOD_HEALTH_EVOLUTION ALTER COLUMN OMG_TECHNICAL_DEBT_ADDED TYPE BIGINT USING OMG_TECHNICAL_DEBT_ADDED::BIGINT;
                ALTER TABLE MOD_HEALTH_EVOLUTION ALTER COLUMN OMG_TECHNICAL_DEBT_DELETED TYPE BIGINT USING OMG_TECHNICAL_DEBT_DELETED::BIGINT;
            END IF;
         EXCEPTION
            WHEN OTHERS THEN 
                RAISE NOTICE 'Cannot change type of columns OMG_TECHNICAL_DEBT, OMG_TECHNICAL_DEBT_ADDED, OMG_TECHNICAL_DEBT_ADDED already exist fo XXX_HEALTH_YYY tables';
        END;
    END;
$$
