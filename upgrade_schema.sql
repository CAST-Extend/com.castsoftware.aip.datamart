...
DO $$ 
    BEGIN
        ...
        BEGIN 
            ALTER TABLE APP_HEALTH_SCORES ADD COLUMN OMG_TECHNICAL_DEBT INT;
            ALTER TABLE MOD_HEALTH_SCORES ADD COLUMN OMG_TECHNICAL_DEBT INT;
            ALTER TABLE APP_HEALTH_EVOLUTION ADD COLUMN OMG_TECHNICAL_DEBT_ADDED INT;
            ALTER TABLE APP_HEALTH_EVOLUTION ADD COLUMN OMG_TECHNICAL_DEBT_DELETED INT;
            ALTER TABLE MOD_HEALTH_EVOLUTION ADD COLUMN OMG_TECHNICAL_DEBT_ADDED INT;
            ALTER TABLE MOD_HEALTH_EVOLUTION ADD COLUMN OMG_TECHNICAL_DEBT_DELETED INT;
        EXCEPTION
            WHEN OTHERS THEN 
