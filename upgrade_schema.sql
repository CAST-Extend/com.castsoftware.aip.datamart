...
DO $$ 
    BEGIN
        ...
        EXCEPTION
            WHEN OTHERS THEN 
                RAISE NOTICE 'columns BUSINESS_CRITERION_ID, BUSINESS_CRITERION_NAME, TECHNICAL_CRITERION_WEIGHT, TECHNICAL_CRITERION_ID already exists for DIM_RULES';
        END;
        ...
        EXCEPTION
            WHEN OTHERS THEN 
                RAISE NOTICE 'columns METRIC_ID, OBJECT_FULL_NAME already exists for USR_ACTION_PLAN';
        END;
