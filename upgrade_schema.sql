    ...
    BEGIN
        ...
        BEGIN 
            ...
            (
                ...
                REMEDIATION_EFFORT_ADDED INT,
                REMEDIATION_EFFORT_DELETED INT,                
        ...
        BEGIN 
            ALTER TABLE APP_SIZING_EVOLUTION ADD COLUMN REMEDIATION_EFFORT_ADDED INT;
            ALTER TABLE APP_SIZING_EVOLUTION ADD COLUMN REMEDIATION_EFFORT_DELETED INT;
        EXCEPTION
            WHEN OTHERS THEN 
                RAISE NOTICE 'columns REMEDIATION_EFFORT_ADDED, REMEDIATION_EFFORT_DELETED already exists for APP_SIZING_EVOLUTION';
        END;

        BEGIN 
            ALTER TABLE MOD_SIZING_EVOLUTION ADD COLUMN REMEDIATION_EFFORT_ADDED INT;
            ALTER TABLE MOD_SIZING_EVOLUTION ADD COLUMN REMEDIATION_EFFORT_DELETED INT;
        EXCEPTION
            WHEN OTHERS THEN 
                RAISE NOTICE 'columns REMEDIATION_EFFORT_ADDED, REMEDIATION_EFFORT_DELETED already exists for MOD_SIZING_EVOLUTION';
        END;

        BEGIN 
            ALTER TABLE APP_HEALTH_SCORES ADD COLUMN REMEDIATION_EFFORT_ADDED INT;
            ALTER TABLE APP_HEALTH_SCORES ADD COLUMN REMEDIATION_EFFORT_DELETED INT;
        EXCEPTION
            WHEN OTHERS THEN 
                RAISE NOTICE 'columns REMEDIATION_EFFORT_ADDED, REMEDIATION_EFFORT_DELETED already exists for APP_HEALTH_SCORES';
        END;
        
        BEGIN 
            ALTER TABLE MOD_HEALTH_SCORES ADD COLUMN REMEDIATION_EFFORT_ADDED INT;
            ALTER TABLE MOD_HEALTH_SCORES ADD COLUMN REMEDIATION_EFFORT_DELETED INT;
        EXCEPTION
            WHEN OTHERS THEN 
                RAISE NOTICE 'columns REMEDIATION_EFFORT_ADDED, REMEDIATION_EFFORT_DELETED already exists for MOD_HEALTH_SCORES';
        END;
