...
* __Edit configuration variables__ in ```setenv.bat``` file
  * PostgreSQL executables if you __do not use__ the embedded third party binaries:
  ...
  * PostgreSQL disribution if you __use__ the embedded third party binaries:
      * ```PGSQL```: the PostgreSQL distribution according to your windows version
  * Target Database:
