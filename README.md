...
INSERT into dss_metric_histo_tree(snapshot_id, metric_parent_id, metric_id, metric_index, metric_type,
aggregate_weight, metric_critical)
SELECT snapshot_id, metric_parent_id, metric_id, metric_index, metric_type,
aggregate_weight, metric_critical
